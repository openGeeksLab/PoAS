...
#### PoS variant
We can also derivate a variant for this protocol when there is only type C mining: every Miner mines with their own stakes and it becomes a pure PoS consensus. This variant system also can ensure the fairness and solves several common problems under the traditional PoS protocol except the wealth distribution issue.<br><br>
